# Generated by Django 4.1.3 on 2023-01-29 15:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_images', models.ImageField(upload_to='images', validators=[projectapp.validator.validate_file_size])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projectapp.stud_reg')),
            ],
        ),
    ]
